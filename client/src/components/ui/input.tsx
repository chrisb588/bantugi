  ...
  return (
    type == "search" ? (
      <input
        ...
        data-slot="input"
        className={cn(
          "file:text-foreground placeholder:text-muted-foreground px-3 selection:text-primary-foreground text-base file:text-sm file:font-medium md:text-sm",
          className
        )}
        {...props}
      />
    ...
    (
      <input
        ...
        className={cn(
          ...
          "aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive cursor-text",
          className
        )}
        {...props}
      />
